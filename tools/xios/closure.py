...
Sources:
  ...
  Packages.procursus -> https://apt.procurs.us/ dists/iphoneos-arm64/1800 main
"""
import re, sys, os
...
SEEDS = ["iosc", "iosc-shell", "foot", "nautilus", "bash", "coreutils",
         ...
         "com.max.xios"]  # com.max.xios = Xios display app; iosc is useless without it (see inspection notes)
...
md.append("- `https://apt.procurs.us/` -- `dists/iphoneos-arm64/1800` (identical bytes to `/1700`), component `main`, index `main/binary-iphoneos-arm/Packages{,.xz,.zst}`; stanzas say `Architecture: iphoneos-arm` and files live under `pool/main/iphoneos-arm64/1700/...`\n")
md.append("## Seeds\n")
